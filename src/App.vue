<template>
  <div id="app">
    ...
    <day-template :labels="options.labels" :header="fcHeader" :date="currdate" :events="events" :isLabelShow="true" v-show="showIndex==2" ref="Day"/>
    <MonthTemplate :events="events" :options="options" :moveEventCallback="moveEvent"  v-show="showIndex==0" ref="Month"/>
    <WeekTemplate :events="events" :options="options" v-show="showIndex==1" :notArranged="notArranged"  ref="Week"/>
  </div>
</template>
