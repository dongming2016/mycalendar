    ...
    <div>
      ...
      <div v-else>
        ...
        <div style="text-align:left;">
          ...
          <router-link to="/openCourse/0" style="margin-left:20px;"><el-button type="primary" icon="el-icon-edit" >开课管理</el-button></router-link>
        </div>
        </div>
      </div>
      <!-- </el-dialog> -->
      <!-- <el-row :gutter="20">
        ...
        <!-- <el-col :span="24" v-if="!isEditShow"> -->
          <OptionalCourseTable :viewCallBack="showEditCourse" :editCallback="showEditCourse" v-on:viewCourse="viewCourse" :onlyRead="$route.params.type==='0'"/>
        <!-- </el-col>
