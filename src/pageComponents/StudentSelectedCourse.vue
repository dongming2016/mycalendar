...
<div>
    ...
    min-height: 650px;">
     <el-table
     style="display: inline-block;margin: 8px 2%;height:600px;"
    border
    ...
    <el-table-column
      ...
      <template slot-scope="props">
        <el-button type="primary" size="mini" @click="unslectCourse(props.row.id, props.row.className)">退课</el-button>
